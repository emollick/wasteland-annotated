...
const SHARED = process.env.COMMENTARY_DIR || (fs.existsSync('/mnt/project-files/commentary') ? '/mnt/project-files/commentary' : path.join(ROOT, 'commentary'));
const DIR = args.find(a => !a.startsWith('--')) || path.join(SHARED, 'pathways');
